...
class AppSettings
{
    ...
    private const REGISTRY = [
        ...
        'image_fallback_engines' => ['path' => 'cubfable.ai.fallback_engines', 'cast' => 'string'],
        'image_group_generation' => ['path' => 'cubfable.ai.group_generation', 'cast' => 'bool'],
        'image_quality' => ['path' => 'cubfable.ai.image_quality', 'cast' => 'string'],
        ...
        'pdf_font_en' => ['path' => 'cubfable.pdf.fonts.en', 'cast' => 'string'],
        'pdf_font_ar' => ['path' => 'cubfable.pdf.fonts.ar', 'cast' => 'string'],
        'pdf_font_tr' => ['path' => 'cubfable.pdf.fonts.tr', 'cast' => 'string'],
        'pdf_font_es' => ['path' => 'cubfable.pdf.fonts.es', 'cast' => 'string'],
        'pdf_font_fr' => ['path' => 'cubfable.pdf.fonts.fr', 'cast' => 'string'],
        'pdf_font_de' => ['path' => 'cubfable.pdf.fonts.de', 'cast' => 'string'],
        'pdf_font_it' => ['path' => 'cubfable.pdf.fonts.it', 'cast' => 'string'],
        'pdf_font_pt' => ['path' => 'cubfable.pdf.fonts.pt', 'cast' => 'string'],
        'pdf_font_ru' => ['path' => 'cubfable.pdf.fonts.ru', 'cast' => 'string'],
        'pdf_font_hi' => ['path' => 'cubfable.pdf.fonts.hi', 'cast' => 'string'],
